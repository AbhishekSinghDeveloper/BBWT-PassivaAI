...
fieldOrVariableList
    : (columnRef | AT_SIGN_SYMBOL textOrIdentifier | NUMBER_SIGN_SYMBOL textOrIdentifier) (
        COMMA_SYMBOL (
            columnRef
            | AT_SIGN_SYMBOL textOrIdentifier
            | AT_TEXT_SUFFIX
            | NUMBER_SIGN_SYMBOL textOrIdentifier
            | NUMBER_TEXT_SUFFIX
        )
    )*
    ;
...
roleOrPrivilege
    : (
        ...
        | roleIdentifierOrText (AT_TEXT_SUFFIX | AT_SIGN_SYMBOL textOrIdentifier | NUMBER_TEXT_SUFFIX | NUMBER_SIGN_SYMBOL textOrIdentifier)
    )
...
explainInto
    ...
    | INTO_SYMBOL NUMBER_SIGN_SYMBOL textOrIdentifier
    ;
...
predicateOperations
    : IN_SYMBOL (subquery | userVariable | OPEN_PAR_SYMBOL exprList CLOSE_PAR_SYMBOL) # predicateExprIn
