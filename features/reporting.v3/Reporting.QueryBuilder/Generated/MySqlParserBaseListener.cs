...
public partial class MySqlParserBaseListener : IMySqlParserListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterContextVariable([NotNull] MySqlParser.ContextVariableContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MySqlParser.contextVariable"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitContextVariable([NotNull] MySqlParser.ContextVariableContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="MySqlParser.emittedVariable"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterEmittedVariable([NotNull] MySqlParser.EmittedVariableContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MySqlParser.emittedVariable"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitEmittedVariable([NotNull] MySqlParser.EmittedVariableContext context) { }
	/// <summary>
