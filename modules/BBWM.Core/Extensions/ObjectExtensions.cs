...
{
    public static object DeepCopy(this object originalObject) => InternalCopy(originalObject, new Dictionary<object, object>());
    ...
    private static object InternalCopy(object originalObject, IDictionary<object, object> visited)
    {
        ...
        if (typeToReflect.IsArray)
        {
            ...
            if (!IsPrimitive(arrayType))
            {
                ...
                {
                    clonedArray.SetValue(InternalCopy(clonedArray.GetValue(index), visited), index);
                }
            }
        }
    ...
    public static string ToString(this object o, int length) =>
        o?.ToString().MaxLength(length);
}
