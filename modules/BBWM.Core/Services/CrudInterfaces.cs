...
The benefit of these interfaces in comparison to the aggregated one we had previously
– you can customize a particular option with no need to inherit any base CRUD service,
avoiding extra-dependency and extra-complexity. A business service with declared interfaces
explicitly describes its behaviour.
*/
...
/// <summary>
/// Defines a generalized method to get a paged list of entities.
/// </summary>
/// <remarks>
/// <para><see href="https://wiki.bbconsult.co.uk/display/BLUEB/Grid+Pages+Automation">See Wiki page</see></para>
/// </remarks>
/// <typeparam name="TDTO">DTO type.</typeparam>
public interface IEntityPage<TDTO> : IDataHandler
    where TDTO : class
{
    /// <summary>
    ...
    Task<PageResult<TDTO>> GetPage(QueryCommand command, CancellationToken ct = default);
}
...
/// <typeparam name="TKey">ID field type of entity.</typeparam>
public interface ICrudHandler<TEntity, TDTO, TPageDTO, TKey> :
    IEntityGet<TDTO, TKey>,
    IEntityCreate<TDTO>,
    IEntityUpdate<TDTO>,
    IEntityDelete<TKey>,
    IEntityPage<TPageDTO>
...
/// <typeparam name="TDTO">Entity's DTO type.</typeparam>
/// <typeparam name="TPageDTO">Paged list entity's DTO type.</typeparam>
public interface ICrudHandler<TEntity, TDTO, TPageDTO>
    : ICrudHandler<TEntity, TDTO, TPageDTO, int>
...
/// <summary>
/// Defines a validation method to check a saving DTO inside the Create and Update methods.
/// </summary>
/// <remarks>
/// <para><see href="https://wiki.bbconsult.co.uk/display/BLUEB/Grid+Pages+Automation">See Wiki page</see></para>
/// </remarks>
/// <typeparam name="TDTO">DTO type.</typeparam>
/// <typeparam name="TKey">ID field type of entity.</typeparam>
public interface IEnityValidate<TDTO, TKey> : IDataHandler
    where TKey : IEquatable<TKey>
    where TDTO : class, IDTO<TKey>
{
    /// <summary>
    /// Gets entity by ID.
    /// </summary>
    /// <param name="dto">ID of requested entity.</param>
    /// <param name="ct">Cancellation token.</param>
    /// <returns>DTO of requested entity.</returns>
    void Validate(TDTO dto, CancellationToken ct = default);
}
...
/// </remarks>
/// <typeparam name="TDTO">DTO type.</typeparam>
public interface IEntityValidate<TDTO> : IEnityValidate<TDTO, int>
    where TDTO : class, IDTO
{
}
