...
/// <summary>
/// HTML rendering service with the Razor engine
/// </summary>
public class ViewRenderService : IViewRenderService
{
    ...
    /// <summary>
    /// Forming HTML based on View and Model
    /// </summary>
    /// <param name="viewName">Name View Model</param>
    /// <param name="model">Model used to form View</param>
