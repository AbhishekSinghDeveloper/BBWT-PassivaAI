...
namespace BBWM.Demo.Data.Migrations.MySql
{
    ...
    [Migration("20210120054354_ChangeEmployeeRegistrationDateColumnAsOptional")]
    partial class ChangeEmployeeRegistrationDateColumnAsOptional
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BBWM.Demo.Model.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBWM.Demo.Model.PersonsPet", b =>
                {
                    ...
                    b.ToTable("PersonsPets");
                });

            modelBuilder.Entity("BBWM.Demo.Model.Pet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBWM.Demo.Northwind.Model.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBWM.Demo.Ssrs.ReportUser", b =>
                {
            ...
            modelBuilder.Entity("BBWM.Demo.Model.Person", b =>
                {
                    b.HasOne("BBWM.Demo.Northwind.Model.Organization", "Organization")
                        .WithMany()
            ...
            modelBuilder.Entity("BBWM.Demo.Model.PersonsPet", b =>
                {
                    b.HasOne("BBWM.Demo.Model.Person", "Person")
                        .WithMany("Pets")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BBWM.Demo.Model.Pet", "Pet")
                        .WithMany("Persons")
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BBWM.Demo.Northwind.Model.Car", b =>
                {
                    b.HasOne("BBWM.Demo.Northwind.Model.Color", "Color")
                        .WithMany()
