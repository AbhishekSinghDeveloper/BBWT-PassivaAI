...
import { HttpResponsesHandlersFactory, IHttpResponseHandlerSettings } from "@bbwt/modules/data-service/http-responses-handler";
import { IDateFilter, IQueryCommand } from "../../filter";
import { IPagedData } from "../interfaces/paged-data";
import { IPagedReaderService } from "../interfaces/paged-reader-service";
import { SetLocalTimeZone, SetUTCTimeZone } from "@bbwt/utils";


export abstract class PagedReaderService<TEntity> extends CrudService<TEntity> implements IPagedReaderService<TEntity> {
    readonly type: string;


    protected constructor(http: HttpClient, handlersFactory: HttpResponsesHandlersFactory) {
        super(http, handlersFactory);
        this.type = "pagedReaderCrudService";
    }
