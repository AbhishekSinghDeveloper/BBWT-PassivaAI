        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MultiUserFormAssociations_MultiUserFormDefinition_MultiUserF~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MultiUserFormDefinitionOrganization_MultiUserFormDefinition_~",
                        column: x => x.MultiUserFormDefinitionID,
                        principalTable: "MultiUserFormDefinition",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MultiUserFormDefinitionOrganization_Organizations_Organizati~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(type: "longtext", nullable: false),
                    TabComponentKey = table.Column<string>(type: "longtext", nullable: false),
                    InnerTabKey = table.Column<string>(type: "longtext", nullable: false),
                    ReviewerStage = table.Column<bool>(type: "tinyint(1)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MultiUserFormStage_MultiUserFormDefinition_MultiUserFormDefi~",
                        column: x => x.MultiUserFormDefinitionId,
                        principalTable: "MultiUserFormDefinition",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupMultiUserFormStage_MultiUserFormStage_MultiUserFormStag~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalUserEmail = table.Column<string>(type: "longtext", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MultiUserFormAssociationLinks_MultiUserFormAssociations_Mult~",
                        column: x => x.MultiUserFormAssociationsId,
                        principalTable: "MultiUserFormAssociations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MultiUserFormAssociationLinks_MultiUserFormStage_MultiUserFo~",
                        column: x => x.MultiUserFormStageId,
                        principalTable: "MultiUserFormStage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TabKey = table.Column<string>(type: "longtext", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MultiUserFormStagePermissions_MultiUserFormStage_MultiUserFo~",
                        column: x => x.MultiUserFormStageId,
                        principalTable: "MultiUserFormStage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
