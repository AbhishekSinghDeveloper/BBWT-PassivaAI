    ...
    public partial class ChangeWidgetControlSetDropdownManagement : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("UPDATE RbWidgetControlSetItem SET FolderId = " +
                                 "(SELECT TOP(1) FolderId FROM RbTableSet WHERE Id = RbWidgetControlSetItem.TableSetId ORDER BY Id) " +
                                 "WHERE 1 = 1");
            migrationBuilder.Sql("UPDATE RbWidgetControlSetItem SET SourceCode = " +
                                 "(SELECT TOP(1) FolderSourceCode FROM RbTableSet WHERE Id = RbWidgetControlSetItem.TableSetId ORDER BY Id) " +
                                 "WHERE 1 = 1");
